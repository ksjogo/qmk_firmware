...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    KC_A,           KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           TG(1),                                          KC_RIGHT,       KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           KC_A,
    KC_A,           KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,           TG(2),                                          KC_A,           KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           KC_A,
    KC_A,           KC_A,           KC_S,           KC_D,           KC_F,           KC_G,                                                                           KC_H,           KC_J,           KC_K,           KC_L,           KC_A,           KC_A,
    KC_A,           KC_A,           KC_X,           KC_C,           KC_V,           KC_B,           TG(3),                                          KC_A,           KC_N,           KC_M,           KC_UP,          KC_DOT,         KC_A,           KC_RSHIFT,
    KC_A,           KC_B,           KC_C,           KC_D,           KC_E,                                                                                                           KC_LEFT,        KC_DOWN,        KC_RIGHT,       KC_RBRACKET,    KC_A,
                                                                                                    KC_A,           KC_A,           KC_A,           KC_A,
                                                                                                                    KC_A,           KC_A,
                                                                                    KC_SPACE,       KC_A,           KC_A,           KC_A,           KC_A,           KC_A
  ),
